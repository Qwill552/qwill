...
export function GlassButton({ icon, size = 22, tap, pressed }: GlassButtonProps) {
  return (
    <span className={cx(styles.glassButton, pressed && styles.glassButtonPressed)} data-demo-tap={tap}>
